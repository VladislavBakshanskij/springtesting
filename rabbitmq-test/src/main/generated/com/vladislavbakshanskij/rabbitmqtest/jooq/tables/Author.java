...
public class Author extends TableImpl<AuthorRecord> {
     ...
     */
    public final TableField<AuthorRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");
    ...
    /**
     * The column <code>public.author.dateBoth</code>.
     */
    public final TableField<AuthorRecord, OffsetDateTime> DATEBOTH = createField(DSL.name("dateBoth"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
